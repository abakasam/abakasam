...
std::unique_ptr<CoverageRange> CoverageRange::fromValue(protocol::Value* value, ErrorSupport* errors)
{
    ...
    protocol::DictionaryValue* object = DictionaryValue::cast(value);
    errors->push();
    protocol::Value* startLineNumberValue = object->get("startLineNumber");
    errors->setName("startLineNumber");
    result->m_startLineNumber = ValueConversions<int>::fromValue(startLineNumberValue, errors);
    protocol::Value* startColumnNumberValue = object->get("startColumnNumber");
    errors->setName("startColumnNumber");
    result->m_startColumnNumber = ValueConversions<int>::fromValue(startColumnNumberValue, errors);
    protocol::Value* endLineNumberValue = object->get("endLineNumber");
    errors->setName("endLineNumber");
    result->m_endLineNumber = ValueConversions<int>::fromValue(endLineNumberValue, errors);
    protocol::Value* endColumnNumberValue = object->get("endColumnNumber");
    errors->setName("endColumnNumber");
    result->m_endColumnNumber = ValueConversions<int>::fromValue(endColumnNumberValue, errors);
...
{
    std::unique_ptr<protocol::DictionaryValue> result = DictionaryValue::create();
    result->setValue("startLineNumber", ValueConversions<int>::toValue(m_startLineNumber));
    result->setValue("startColumnNumber", ValueConversions<int>::toValue(m_startColumnNumber));
    result->setValue("endLineNumber", ValueConversions<int>::toValue(m_endLineNumber));
    result->setValue("endColumnNumber", ValueConversions<int>::toValue(m_endColumnNumber));
...
DispatchResponse::Status DispatcherImpl::startPreciseCoverage(int callId, std::unique_ptr<DictionaryValue> requestMessageObject, ErrorSupport* errors)
{
    ...
    std::unique_ptr<DispatcherBase::WeakPtr> weak = weakPtr();
    DispatchResponse response = m_backend->startPreciseCoverage();
    if (weak->get())
        weak->get()->sendResponse(callId, response);
    return response.status();
}
